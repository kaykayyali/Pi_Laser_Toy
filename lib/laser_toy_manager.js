...
Laser_Toy_Manager.prototype.start_random = function() {
	var self = this;
	this.interval = setInterval(_.bind(function() {self.random()}, this), 500);
};
...
Laser_Toy_Manager.prototype.random = function() {
	...
	this.tilt_servo.increment_position(random_tilt);
	this.pan_servo.increment_position(random_pan);
};
