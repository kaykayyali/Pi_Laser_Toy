...
Servo.prototype.increment_position = function(delta) {
	var multiplier = (this.multiplier) ? this.multiplier : 5;
	var new_position = this.position + (delta * multiplier);
	this.move_to_position(new_position);
};
